...
const MovieCard = ({ poster_path, overview, popularity, release_date, title } ) => {
  return (
    <div className="rounded overflow-hidden cursor-pointer flex flex-col justify-center items-center w-full movie-card" data-testid='movie-card'>
      <img className="w-[60%] lg:w-[90%] bg-contain bg-center" src={IMG_PATH + poster_path} alt="movie poster" onError={(e) => { e.target.onerror = null; e.target.src = defaultImage }} />
